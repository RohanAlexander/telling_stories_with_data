...
4. What is Tukey's link to DoSS (hint: he was someone's PhD advisor)?
5. Can you identify a female equivalent to Tukey who we (historians of statistics) may have overlooked?
...
Exploratory data analysis is never finished, you just die. It is the active process of exploring and becoming familiar with your data. Like a farmer with their hands in the earth, you need to know every contour and aspect of your data. You need to know how it changes and what are its limits. Exploratory data analysis is the process by which you do this. 

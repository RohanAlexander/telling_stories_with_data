...
Again, now we need to do the work to update things. The default for the 'Distill Blog' setting is that the blog is the homepage. So we can change that. I really liked the bio page from earlier, so we could use that approach.

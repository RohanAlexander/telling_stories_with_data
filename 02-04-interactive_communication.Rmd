...
- Hill, Alison, 2021, 'Up & running with blogdown in 2021', 6 January, https://alison.rbind.io/post/2017-06-12-up-and-running-with-blogdown/.
...
- De Leon, Desirée, 2019, 'Trying out Blogdown', 4 September, http://desiree.rbind.io/post/2019/trying-out-blogdown/. 
- Hill, Alison, 2019, 'A Spoonful of Hugo: Troubleshooting Your Build', 4 March, https://alison.rbind.io/post/2019-03-04-hugo-troubleshooting/.
- Navarro, Danielle, 2018, 'Day 1: Getting started with blogdown', 27 April, https://djnavarro.net/post/starting-blogdown/.
...
- Salmon, Maëlle, 2020, 'What to know before you adopt Hugo/blogdown', 29 February, https://masalmon.eu/2020/02/29/hugo-maintenance/.
...
The third option, and the one that we'll start with, is `postcards` [@citepostcards]. This is a tailored version of `distill` that creates simple biographical websites that look great. 


### Postcards

To get started with `postcards`, we are going to follow @hillpostcards fairly closely and you should go there for further details. We first need to install the packages.
...
The project will then be no your GitHub repo and you can use GitHub pages to host it: 'Settings -> Pages' and then change the source to 'main' or 'master', depending on your settings.
...
This post is a simplified version of the `blogdown` user-guide and the blog post by Alison Presmanes Hill [@citealisonhillblogdown]. It sticks to the basics and doesn't require much decision-making. The purpose is to allow someone without much experience to use `blogdown` to get a website up-and-running. Head to those two resources once you've got a website working and want to dive a bit deeper.
...
Now we want to create a folder in GitHub (because it will be easier to put your website onto the internet if you have a GitHub account). We have seen GitHub earlier in this book, but if you didn't do this at that point, then please create a free GitHub account at https://github.com/. 

...
Thank you to [Monica Alexander](https://www.monicaalexander.com/), Michael Chong, and [Sharla Gelfand](https://sharla.party/) for allowing their code to be used. 
...
- [Chris Bail](https://cbail.github.io/textasdata/Text_as_Data.html)'s *Text as Data*;
- [Andrew Heiss](https://www.andrewheiss.com/)'s *Program Evaluation for Public Service*;
- [Grant McDermott](https://grantmcdermott.com/)'s *Data Science for Economists*; 
- [David Mimno](https://mimno.infosci.cornell.edu/info3350/)'s *Text Mining for History and Literature*
- [Ed Rubin](http://edrub.in/)'s *PhD Econometrics (III)* and *Introduction to Econometrics (II)*;

...
```{r ladiesdrinkingtea, echo=FALSE, fig.cap="Afternoon Tea Party (1890–1891), by Mary Cassatt (American, 1844-1926), as downloaded from https://artvee.com/dl/afternoon-tea-party.", out.width = '90%'}
knitr::include_graphics(here::here("figures/drinking_tea.jpg"))
```
...
```{r, echo=FALSE, fig.cap="'The triumph of wisdom over fortune' by Otto van Veen (Flemish, 1556 - 1629), as downloaded from https://artvee.com/dl/the-triumph-of-wisdom-over-fortune.", out.width = '90%'}
knitr::include_graphics(here::here("figures/wisdom_over_fortune.jpg"))
```
...
```{r toronto_intervention, echo=FALSE, fig.cap = "Example of the results of the intervention.", out.width = '90%'}
...
Again, drawing on @kohavi[Chapter 13], we need to be very aware of what are we actually randomising over? Again, this is something that's kind of obvious in normal RCTs, but gets like really interesting in the case of A/B testing. Let's consider the malaria netting experiments - either a person/village/state gets a net or it doesn't. Easy (relatively). But in the case of server-side A/B testing - are we randomising the page, the session, or the user? 
...
<!-- ## Speed vs quality vs risk -->

<!-- **This is from Chapter 14 of @kohavi.** -->

<!-- This concern is also seen in RCTs, but it's especially of interest -->


## Case study - Upworthy

To see this in action let's look at the Upworthy dataset [@upworthy].

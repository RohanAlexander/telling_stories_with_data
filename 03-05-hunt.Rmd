...
```{r upworthy, echo=FALSE, fig.cap = "Comparison of the average number of clicks when a headline contains a question mark or not."}

to_question_or_not_to_question %>% 
  mutate(row_number = c(1:nrow(to_question_or_not_to_question))) %>% 

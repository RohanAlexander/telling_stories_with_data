...
- References - [4 'Perfect', 3 'One minor issue', 0 'Poor or not done']
	...
	- 3 means one minor issue. More than one minor issues receives 0.
- Reproducibility - [4 'Exceptional', 3 'Great', 2 'Fine', 1 'Gets job done',  0 'Poor or not done']
	...
	- The code must appropriately reads data, prepares it, creates plots, conducts analysis, and generate documents. Seeds are used where needed.
...
- Model - [10 'Exceptional', 8 'Great', 6 'Good', 4 'Some issues', 2 'Many issues',  0 'Poor or not done']
  - The model is well-explained, justified, and appropriate.
  ...
  - Alternative models, or variants, must be discussed and strengths and weaknesses made clear.

...
rubric <- read_csv(here::here("inputs/rubric-paper2.csv"))
#> Rows: 15 Columns: 3
#> ── Column specification ────────────────────────────────────
#> Delimiter: ","
#> chr (3): Component, Range, Requirement
#> 
...
```{=html}
<div id="acandytjry" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>html {
...
#acandytjry .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#acandytjry .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#acandytjry .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#acandytjry .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#acandytjry .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#acandytjry .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#acandytjry .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#acandytjry .gt_from_md > :first-child {
  margin-top: 0;
}

#acandytjry .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#acandytjry .gt_first_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#acandytjry .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#acandytjry .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#acandytjry .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#acandytjry .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#acandytjry .gt_footnote {
  margin: 0px;
  font-size: 90%;
  padding: 4px;
}

#acandytjry .gt_sourcenotes {
  color: #333333;
  background-color: #FFFFFF;
  border-bottom-style: none;
  border-bottom-width: 2px;
...
#acandytjry .gt_font_normal {
  font-weight: normal;
}

#acandytjry .gt_font_bold {
  font-weight: bold;
}

#acandytjry .gt_font_italic {
  font-style: italic;
}

...
# library(huxtable)
# huxreg(running_data_first_model)
```
...
<!-- - Pavlik, Kaylin, 2019, 'Understanding + classifying genres using Spotify audio features', freely available at: https://www.kaylinpavlik.com/classifying-songs-genres/. -->
<!-- - Pavlik, Kaylin, 2018, 'Exploring the Relationship Between Dog Names and Breeds', freely available at: https://www.kaylinpavlik.com/dog-names-tfidf/. -->
<!-- - Silge, Julia, 2020, '#TidyTuesday hotel bookings and recipes', freely available at: https://juliasilge.com/blog/hotels-recipes/. -->
<!-- - Silge, Julia, 2020, 'Hyperparameter tuning and #TidyTuesday food consumption', freely available at: https://juliasilge.com/blog/food-hyperparameter-tune/.  -->
<!-- - Taddy, Matt, 2019, *Business Data Science*, Chapter 4. -->

<!-- **Fun reading!** -->

<!-- - Chellel, Kit, 2018, 'The Gambler Who Cracked the Horse-Racing Code', *Bloomberg Businessweek*, 3 May, freely available at: https://www.bloomberg.com/news/features/2018-05-03/the-gambler-who-cracked-the-horse-racing-code. -->

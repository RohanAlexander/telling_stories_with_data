...
38. According to Gebru et al, 2020, p.2, a datasheet should document a dataset's (please select all that apply):
    a. composition.
    b. recommended uses.
    c. motivation.
...
```{r firstdag, out.width="75%", fig.cap = "Using a DAG to illustrate perceived relationships"}
library(DiagrammeR)
DiagrammeR::grViz("
digraph {
  graph [ranksep = 0.2]
...
```{r carrotasconfounder, out.width="75%", fig.cap = "Carrot as a confounder"}
DiagrammeR::grViz("
digraph {
  graph [ranksep = 0.2]
  node [shape = plaintext]
...
```{r carrotasmediator, out.width="75%", fig.cap = "Carrot as a mediator"}
DiagrammeR::grViz("
digraph {
  graph [ranksep = 0.2]
  node [shape = plaintext]
...
```{r carrotascollider, out.width="75%", fig.cap = "Carrot as a collider"}
DiagrammeR::grViz("
digraph {
  graph [ranksep = 0.2]
  node [shape = plaintext]
